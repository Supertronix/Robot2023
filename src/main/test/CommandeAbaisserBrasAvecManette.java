...
public class CommandeAbaisserBrasAvecManette extends CommandBase implements Finissable{
    ...
    public CommandeAbaisserBrasAvecManette(Bras bras, ManetteTestBras manette, double vitesse)
    {
